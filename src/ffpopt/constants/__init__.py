...
GetRespRadius(z) -> float
    Return the Merz-Kollmann radius in Bohr

GetUffRadius(z) -> float
    Returns the UFF radius in Bohr
...
from . PeriodicTable import GetRespRadius
from . PeriodicTable import GetUffRadius
