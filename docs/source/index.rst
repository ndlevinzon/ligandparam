...
``ligandparam`` is a modular Python toolkit for Amber ligand parameterization.
Workflows are expressed as **recipes** (ordered lists of **stages**) that wrap
familiar tools such as Antechamber, Gaussian, ``parmchk2``, and LEaP.
